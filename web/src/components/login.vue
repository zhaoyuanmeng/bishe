      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="login-div" v-show="MODAL_STATUS === STATUS_LOGIN">
            ...
            <div class="form-group to-register-div"></div>
          </div>
          <div class="register-div" v-show="MODAL_STATUS === STATUS_REGISTER">
            ...
            <div class="form-group">
              ...
              />
              <span
                v-show="registerNameValidate === false"
                class="text-danger"
            ...
            <div class="form-group">
              ...
              />
              <span
                v-show="registerPasswordValidate === false"
                class="text-danger"
              >密码最少6位，包含至少1字母和1个数字</span>
            </div>
            <div class="form-group">
              <input
          ...
          <div class="forget-div" v-show="MODAL_STATUS === STATUS_FORGET">
            ...
            <div class="form-group">
              ...
              />
              <span
                v-show="forgetPasswordValidate === false"
                class="text-danger"
              >密码最少6位，包含至少1字母和1个数字</span>
            </div>
            <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    register() {
      ...
      _this.memberRegister.password = hex_md5(
        _this.memberRegister.passwordOriginal + KEY
      );

      // 调服务端注册接口
      _this.$ajax
        .post(
          process.env.VUE_APP_SERVER + "/business/web/member/register",
    ...
    login() {
      ...
      _this.$ajax
        .post(
          process.env.VUE_APP_SERVER + "/business/web/member/login",
          _this.member
        )
        .then(response => {
          let resp = response.data;
    ...
    loadImageCode: function() {
      ...
      $("#image-code").attr(
        ...
        process.env.VUE_APP_SERVER +
          "/business/web/kaptcha/image-code/" +
    ...
    sendSmsForRegister() {
      ...
      _this.$ajax
        .get(
          process.env.VUE_APP_SERVER +
            "/business/web/member/is-mobile-exist/" +
    ...
    sendSmsCode(sms, btnId) {
      ...
      // 调服务端发短信接口
      _this.$ajax
        .post(process.env.VUE_APP_SERVER + "/business/web/sms/send", sms)
        .then(res => {
          let response = res.data;
          if (response.success) {
            Toast.success("短信已发送");
    ...
    resetPassword() {
      ...
      _this.memberForget.password = hex_md5(
        _this.memberForget.passwordOriginal + KEY
      );

      // 调服务端密码重置接口
      _this.$ajax
        .post(
          process.env.VUE_APP_SERVER + "/business/web/member/reset-password",
          _this.memberForget
        )
        .then(res => {
          let response = res.data;
    ...
    onRegisterMobileBlur() {
      let _this = this;
      _this.registerMobileValidate = Pattern.validateMobile(
        _this.memberRegister.mobile
      );
    ...
    onRegisterMobileCodeBlur() {
      let _this = this;
      _this.registerMobileCodeValidate = Pattern.validateMobileCode(
        _this.memberRegister.smsCode
      );
      return _this.registerMobileValidate;
    },
    ...
    onRegisterNameBlur() {
      let _this = this;
      _this.registerNameValidate = Pattern.validateName(
    ...
    onRegisterPasswordBlur() {
      let _this = this;
      _this.registerPasswordValidate = Pattern.validatePasswordWeak(
    ...
    onRegisterConfirmPasswordBlur() {
      ...
      return (_this.registerConfirmPasswordValidate =
        confirmPassword === _this.memberRegister.passwordOriginal);
    },
    ...
    onForgetMobileBlur() {
      let _this = this;
      return (_this.forgetMobileValidate = Pattern.validateMobile(
        _this.memberForget.mobile
      ));
    },
    ...
    onForgetMobileCodeBlur() {
      let _this = this;
      return (_this.forgetMobileCodeValidate = Pattern.validateMobileCode(
        _this.memberForget.smsCode
      ));
    },

    onForgetPasswordBlur() {
      let _this = this;
      return (_this.forgetPasswordValidate = Pattern.validatePasswordWeak(
        _this.memberForget.passwordOriginal
      ));
    },
    ...
    onForgetConfirmPasswordBlur() {
      ...
      return (_this.forgetConfirmPasswordValidate =
